...
// Placeholders
extern const u8 gText_RaiseToLevelCapPrompt[];
...
extern const u8 gText_AutoLevel[];
extern const u8 gText_PkmnRaisedToLevelCap[];
extern const u8 gText_PkmnAlreadyAtLevelCap[];
